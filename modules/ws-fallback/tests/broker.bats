...
@test "ws-fallback relays redis messages to websocket clients" {
  REDIS_URL=redis://127.0.0.1:6381 WS_BIND=127.0.0.1:9001 scripts/broker.sh > /tmp/wsd.log 2>&1 &
  BROKER_PID=$!
  sleep 1
  ...
  redis-cli -u redis://127.0.0.1:6381 PUBLISH test '<p>hi</p>' > /tmp/pub.log 2>&1
